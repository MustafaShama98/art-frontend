                ...
                <div className="bg-white shadow-lg rounded-lg p-6 border-t-4 flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">
                      <strong>Painting {topDurationPainting.sys_id}</strong> with 
                ...
                <div className="bg-white shadow-md rounded-lg p-6 border-t-4  flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 text-lg">
                      <strong>{`Painting ${topViewsPainting.sys_id}`}</strong> with 
                ...
                <table className="table-auto w-full text-left border-collapse border border-gray-200">
                  ...
                  <tbody>
                    {filteredData.map((painting) => (
                      <tr key={painting.sys_id} className="hover:bg-gray-50">
                        <td className="border border-gray-300 px-4 py-2">{`Painting ${painting.sys_id}`}</td>
